...
from app.routers import admin, ai, auth, drafts, invites, jobs, leaderboard, links, problems, quiz, submissions
...
app.include_router(leaderboard.router, prefix="/api", dependencies=_protected)
